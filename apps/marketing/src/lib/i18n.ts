...
export const translations: Record<Locale, Translations> = {
  de: {
    ...
    faq: {
      ...
      items: [
        ...
        {
          q: "Was, wenn ich kündigen möchte?",
          a: "Du kannst jederzeit kündigen. Bei Problemen hilft unser Support-Team sofort weiter.",
        },
        {
    ...
    prezziPage: {
      ...
      metaDescription: "Transparente Preise ohne versteckte Gebühren. Starter ab €25/Monat. Jederzeit kündbar.",
      ...
      moneyBack: "Jederzeit kündbar",
      moneyBackTitle: "Jederzeit kündbar",
      moneyBackDesc: "Du kannst dein Abo jederzeit mit einem Klick kündigen. Keine Kündigungsfrist, keine versteckten Kosten.",
  ...
  it: {
    ...
    prezziPage: {
      ...
      metaDescription: "Prezzi trasparenti senza costi nascosti. Starter da €25/mese. Cancella quando vuoi.",
      ...
      moneyBack: "Cancella quando vuoi",
      moneyBackTitle: "Cancella quando vuoi",
      moneyBackDesc: "Puoi cancellare il tuo abbonamento in qualsiasi momento con un click. Nessun preavviso, nessun costo nascosto.",
  ...
  es: {
    ...
    faq: {
      ...
      items: [
        ...
        },
        {
          ...
          a: "Puedes cancelar en cualquier momento. Si tienes problemas, nuestro equipo de soporte te ayudará de inmediato.",
        },
        {
    ...
    prezziPage: {
      ...
      metaDescription: "Precios transparentes sin costes ocultos. Starter desde €25/mes. Cancela cuando quieras.",
      ...
      moneyBack: "Cancela cuando quieras",
      moneyBackTitle: "Cancela cuando quieras",
      moneyBackDesc: "Puedes cancelar tu suscripción en cualquier momento con un clic. Sin preaviso, sin costes ocultos.",
  ...
  fr: {
    ...
    faq: {
      ...
      items: [
        ...
        },
        {
          ...
          a: "Vous pouvez résilier à tout moment. En cas de problème, notre équipe support vous aide immédiatement.",
        },
        {
    ...
    prezziPage: {
      ...
      metaDescription: "Tarifs transparents sans frais cachés. Starter à partir de €25/mois. Résiliez quand vous voulez.",
      ...
      moneyBack: "Résiliez quand vous voulez",
      moneyBackTitle: "Résiliez quand vous voulez",
      moneyBackDesc: "Vous pouvez résilier votre abonnement à tout moment en un clic. Sans préavis, sans frais cachés.",
  ...
  nl: {
    ...
    faq: {
      ...
      items: [
        ...
        {
          q: "En als ik wil opzeggen?",
          a: "Je kunt op elk moment opzeggen. Bij problemen helpt ons supportteam je direct.",
        },
        {
    ...
    prezziPage: {
      ...
      metaDescription: "Transparante prijzen zonder verborgen kosten. Starter vanaf €25/maand. Altijd opzegbaar.",
      ...
      moneyBack: "Altijd opzegbaar",
      moneyBackTitle: "Altijd opzegbaar",
      moneyBackDesc: "Je kunt je abonnement op elk moment met één klik opzeggen. Geen opzegtermijn, geen verborgen kosten.",
  ...
  pt: {
    ...
    faq: {
      ...
      items: [
        ...
        },
        {
          ...
          a: "Pode cancelar a qualquer momento. Em caso de problemas, a nossa equipa de suporte ajuda-o imediatamente.",
        },
        {
    ...
    prezziPage: {
      ...
      metaDescription: "Preços transparentes sem custos ocultos. Starter a partir de €25/mês. Cancele quando quiser.",
      ...
      moneyBack: "Cancele quando quiser",
      moneyBackTitle: "Cancele quando quiser",
      moneyBackDesc: "Pode cancelar a sua subscrição a qualquer momento com um clique. Sem aviso prévio, sem custos ocultos.",
  ...
  en: {
    ...
    faq: {
      ...
      items: [
        ...
        },
        {
          ...
          a: "You can cancel at any time. If you have any issues, our support team will help you immediately.",
        },
        {
    ...
    prezziPage: {
      ...
      metaDescription: "Transparent pricing with no hidden fees. Starter from €25/month. Cancel anytime.",
      ...
      moneyBackTitle: "Cancel anytime",
      moneyBackDesc: "You can cancel your subscription at any time with one click. No notice period, no hidden fees.",
