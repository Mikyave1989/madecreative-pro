...
const L: Record<string, {
  ...
  de: { monthly: "Monatlich", annual: "Jährlich", perMonth: "/Mo.", perYear: "/Jahr", save: "2 Monate gratis", free: "Kostenlos", startFree: "Kostenlos starten", getCta: "Jetzt starten", popular: "Beliebteste", guarantee: "14 Tage Geld-zurück-Garantie", noCard: "Keine Kreditkarte", noContract: "Kein Vertrag", cancel: "Jederzeit kündbar", current: "Aktueller Plan", features: "Funktionen" },
  it: { monthly: "Mensile", annual: "Annuale", perMonth: "/mese", perYear: "/anno", save: "2 mesi gratis", free: "Gratis", startFree: "Inizia gratis", getCta: "Inizia ora", popular: "Più scelto", guarantee: "14 giorni soddisfatti o rimborsati", noCard: "Nessuna carta richiesta", noContract: "Nessun contratto", cancel: "Cancelli quando vuoi", current: "Piano attuale", features: "Funzionalità" },
  en: { monthly: "Monthly", annual: "Annual", perMonth: "/mo", perYear: "/year", save: "2 months free", free: "Free", startFree: "Start free", getCta: "Get started", popular: "Most popular", guarantee: "14-day money-back guarantee", noCard: "No credit card", noContract: "No contract", cancel: "Cancel anytime", current: "Current plan", features: "Features" },
  es: { monthly: "Mensual", annual: "Anual", perMonth: "/mes", perYear: "/año", save: "2 meses gratis", free: "Gratis", startFree: "Empezar gratis", getCta: "Empezar ahora", popular: "Más elegido", guarantee: "14 días de garantía", noCard: "Sin tarjeta", noContract: "Sin contrato", cancel: "Cancela cuando quieras", current: "Plan actual", features: "Funciones" },
  fr: { monthly: "Mensuel", annual: "Annuel", perMonth: "/mois", perYear: "/an", save: "2 mois offerts", free: "Gratuit", startFree: "Commencer gratuitement", getCta: "Commencer", popular: "Le plus populaire", guarantee: "Garantie 14 jours", noCard: "Sans carte", noContract: "Sans engagement", cancel: "Résiliez quand vous voulez", current: "Plan actuel", features: "Fonctionnalités" },
  nl: { monthly: "Maandelijks", annual: "Jaarlijks", perMonth: "/mnd", perYear: "/jaar", save: "2 maanden gratis", free: "Gratis", startFree: "Gratis starten", getCta: "Nu beginnen", popular: "Meest gekozen", guarantee: "14 dagen geld-terug", noCard: "Geen creditcard", noContract: "Geen contract", cancel: "Altijd opzegbaar", current: "Huidig plan", features: "Functies" },
  pt: { monthly: "Mensal", annual: "Anual", perMonth: "/mês", perYear: "/ano", save: "2 meses grátis", free: "Grátis", startFree: "Começar grátis", getCta: "Começar agora", popular: "Mais escolhido", guarantee: "14 dias de garantia", noCard: "Sem cartão", noContract: "Sem contrato", cancel: "Cancele quando quiser", current: "Plano atual", features: "Recursos" },
};
