...
/* ── Portal signup URLs ───────────────────────────────────────────────── */
function getSignupUrl(plan: string, billing: "monthly" | "annual") {
  return `https://app.madecreative.pro/signup?plan=${plan}&billing=${billing}`;
}

/* ── i18n labels ────────────────────────────────────────────────────────── */
const L: Record<string, {
  monthly: string; annual: string; perMonth: string; perYear: string;
  save: string; getCta: string; popular: string; guarantee: string;
  noCard: string; noContract: string; cancel: string; current: string;
  features: string;
}> = {
  de: { monthly: "Monatlich", annual: "Jährlich", perMonth: "/Mo.", perYear: "/Jahr", save: "2 Monate gratis", getCta: "Jetzt starten", popular: "Beliebteste", guarantee: "Jederzeit kündbar", noCard: "Keine Kreditkarte", noContract: "Kein Vertrag", cancel: "Jederzeit kündbar", current: "Aktueller Plan", features: "Funktionen" },
  it: { monthly: "Mensile", annual: "Annuale", perMonth: "/mese", perYear: "/anno", save: "2 mesi gratis", getCta: "Inizia ora", popular: "Più scelto", guarantee: "Cancella quando vuoi", noCard: "Nessuna carta richiesta", noContract: "Nessun contratto", cancel: "Cancelli quando vuoi", current: "Piano attuale", features: "Funzionalità" },
  en: { monthly: "Monthly", annual: "Annual", perMonth: "/mo", perYear: "/year", save: "2 months free", getCta: "Get started", popular: "Most popular", guarantee: "Cancel anytime", noCard: "No credit card", noContract: "No contract", cancel: "Cancel anytime", current: "Current plan", features: "Features" },
  es: { monthly: "Mensual", annual: "Anual", perMonth: "/mes", perYear: "/año", save: "2 meses gratis", getCta: "Empezar ahora", popular: "Más elegido", guarantee: "Cancela cuando quieras", noCard: "Sin tarjeta", noContract: "Sin contrato", cancel: "Cancela cuando quieras", current: "Plan actual", features: "Funciones" },
  fr: { monthly: "Mensuel", annual: "Annuel", perMonth: "/mois", perYear: "/an", save: "2 mois offerts", getCta: "Commencer", popular: "Le plus populaire", guarantee: "Résiliez quand vous voulez", noCard: "Sans carte", noContract: "Sans engagement", cancel: "Résiliez quand vous voulez", current: "Plan actuel", features: "Fonctionnalités" },
  nl: { monthly: "Maandelijks", annual: "Jaarlijks", perMonth: "/mnd", perYear: "/jaar", save: "2 maanden gratis", getCta: "Nu beginnen", popular: "Meest gekozen", guarantee: "Altijd opzegbaar", noCard: "Geen creditcard", noContract: "Geen contract", cancel: "Altijd opzegbaar", current: "Huidig plan", features: "Functies" },
  pt: { monthly: "Mensal", annual: "Anual", perMonth: "/mês", perYear: "/ano", save: "2 meses grátis", getCta: "Começar agora", popular: "Mais escolhido", guarantee: "Cancele quando quiser", noCard: "Sem cartão", noContract: "Sem contrato", cancel: "Cancele quando quiser", current: "Plano atual", features: "Recursos" },
};
