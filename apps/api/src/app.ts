...
app.post("/internal/send-preview-email/:prospectId", async (c) => {
  ...
  const bodies: Record<string, string> = {
    de: `<p>Sehr geehrte Damen und Herren von <strong>${name}</strong>,</p><p>wir haben uns Ihr Unternehmen${city ? ` in ${city}` : ""} angesehen und - vollkommen kostenlos - einen <strong>Vorschlag für Ihre neue Website</strong> erstellt.</p><p style="text-align:center;margin:28px 0"><a href="${previewUrl}" style="background:#6366f1;color:#fff;padding:14px 32px;border-radius:10px;text-decoration:none;font-weight:bold;font-size:16px">Website-Vorschau ansehen -></a></p><p>Ab <strong>${pl}</strong>. Jederzeit kündbar.</p><p style="text-align:center;margin:20px 0"><a href="${signupUrl}" style="background:#059669;color:#fff;padding:12px 28px;border-radius:8px;text-decoration:none;font-weight:bold">Jetzt kaufen & bearbeiten -></a></p><p>Kontaktieren Sie uns auch auf WhatsApp: <a href="https://wa.me/393317389918">https://wa.me/393317389918</a></p><p>Beste Grüße,<br><strong>Marco Bianchi</strong><br>MadeCreative</p>`,
    it: `<p>Gentili responsabili di <strong>${name}</strong>,</p><p>abbiamo analizzato la vostra attività${city ? ` a ${city}` : ""} e creato gratuitamente una <strong>proposta per il vostro nuovo sito web</strong>.</p><p style="text-align:center;margin:28px 0"><a href="${previewUrl}" style="background:#6366f1;color:#fff;padding:14px 32px;border-radius:10px;text-decoration:none;font-weight:bold;font-size:16px">Vedi l'anteprima -></a></p><p>Da <strong>${pl}</strong>. Senza vincoli.</p><p style="text-align:center;margin:20px 0"><a href="${signupUrl}" style="background:#059669;color:#fff;padding:12px 28px;border-radius:8px;text-decoration:none;font-weight:bold">Acquista e modifica -></a></p><p>Puoi contattarci anche su WhatsApp: <a href="https://wa.me/393317389918">https://wa.me/393317389918</a></p><p>Cordiali saluti,<br><strong>Marco Bianchi</strong><br>MadeCreative</p>`,
    fr: `<p>Chère équipe de <strong>${name}</strong>,</p><p>Nous avons créé gratuitement une <strong>proposition de nouveau site web</strong>.</p><p style="text-align:center;margin:28px 0"><a href="${previewUrl}" style="background:#6366f1;color:#fff;padding:14px 32px;border-radius:10px;text-decoration:none;font-weight:bold;font-size:16px">Voir l'aperçu -></a></p><p>À partir de <strong>${pl}</strong>. Sans engagement.</p><p style="text-align:center;margin:20px 0"><a href="${signupUrl}" style="background:#059669;color:#fff;padding:12px 28px;border-radius:8px;text-decoration:none;font-weight:bold">Acheter et modifier -></a></p><p>Contactez-nous aussi sur WhatsApp: <a href="https://wa.me/393317389918">https://wa.me/393317389918</a></p><p>Cordialement,<br><strong>Marco Bianchi</strong><br>MadeCreative</p>`,
    es: `<p>Estimado equipo de <strong>${name}</strong>,</p><p>Hemos creado gratuitamente una <strong>propuesta para su nuevo sitio web</strong>.</p><p style="text-align:center;margin:28px 0"><a href="${previewUrl}" style="background:#6366f1;color:#fff;padding:14px 32px;border-radius:10px;text-decoration:none;font-weight:bold;font-size:16px">Ver vista previa -></a></p><p>Desde <strong>${pl}</strong>. Sin compromiso.</p><p style="text-align:center;margin:20px 0"><a href="${signupUrl}" style="background:#059669;color:#fff;padding:12px 28px;border-radius:8px;text-decoration:none;font-weight:bold">Comprar y editar -></a></p><p>Contáctenos también por WhatsApp: <a href="https://wa.me/393317389918">https://wa.me/393317389918</a></p><p>Saludos,<br><strong>Marco Bianchi</strong><br>MadeCreative</p>`,
    en: `<p>Dear <strong>${name}</strong> team,</p><p>We built a free website preview for your business${city ? ` in ${city}` : ""}.</p><p style="text-align:center;margin:28px 0"><a href="${previewUrl}" style="background:#6366f1;color:#fff;padding:14px 32px;border-radius:10px;text-decoration:none;font-weight:bold;font-size:16px">View your preview -></a></p><p>From <strong>${pl}</strong>. Cancel anytime.</p><p style="text-align:center;margin:20px 0"><a href="${signupUrl}" style="background:#059669;color:#fff;padding:12px 28px;border-radius:8px;text-decoration:none;font-weight:bold">Buy & Edit -></a></p><p>You can also reach us on WhatsApp: <a href="https://wa.me/393317389918">https://wa.me/393317389918</a></p><p>Best regards,<br><strong>Marco Bianchi</strong><br>MadeCreative</p>`,
  };
